...
export const Profile = () => {
  ...
  return (
    <div className=" flex flex-col space-y-5 items-center animate-fadeIn mt-[75px] md:mt-0">
      ...
      <div className="flex flex-col xl:flex-row justify-center items-start space-y-5 xl:space-x-5 xl:space-y-0">
        <div className="w-[100%] xl:w-[50%] bg-slate-200 p-3">
