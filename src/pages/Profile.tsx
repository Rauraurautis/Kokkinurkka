...
export const Profile = () => {
  ...
  return (
    <div className=" flex flex-col space-y-5 items-center animate-fadeIn mt-[75px] md:mt-0 w-[100%]">
      <div className="bg-slate-200 flex text-center justify-around w-[50%] p-1 rounded-md min-w-[300px]">
      ...
      <div className="flex flex-col xl:flex-row justify-center items-start space-y-5 xl:space-x-5 xl:space-y-0 min-w-[100%]">
        <div className="min-w-[100%] xl:min-w-[50%] bg-slate-200 p-3">
          <h1 className="text-center font-bold mb-2 bg-slate-300">Suosikkireseptit</h1>
          <div className="grid-cols-4 grid max-h-[300px] overflow-y-auto space-x-2 min-h-[150px]">
